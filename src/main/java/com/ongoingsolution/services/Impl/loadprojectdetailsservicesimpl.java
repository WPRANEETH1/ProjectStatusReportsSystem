...
//        JSONArray ZTE_P2 = loadprojectdetailsdao.getProjectNameWithCategoryBuUserName(userName, "Immediate Expansion_ZTE P2");
        ...
        JSONArray Transmission_Implementation = loadprojectdetailsdao.getProjectNameWithCategoryBuUserNameotherProject(userName, "Transmission Implementation");
...
//        JSONArray ZTE_P2 = loadprojectdetailsdao.getProjectNameWithCategoryBuManager("Immediate Expansion_ZTE P2");
        ...
        JSONArray Transmission_Implementation = loadprojectdetailsdao.getProjectNameWithCategoryBuManagerotherProject("Transmission Implementation");
