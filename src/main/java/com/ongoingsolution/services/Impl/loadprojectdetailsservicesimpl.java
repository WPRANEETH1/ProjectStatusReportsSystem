...
//    ------------------------------------------------------------------
    ...
    public Response getProjectNameWithCategoryByManager() {
        ...
        JSONArray otherdata = loadprojectdetailsdao.getProjectNameWithCategoryBuManagerotherProject("Other");
        ...
        JSONArray CTN = loadprojectdetailsdao.getProjectNameWithCategoryBuManager("CTN");
