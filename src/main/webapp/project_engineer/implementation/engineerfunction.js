...
function loadEngineerFunction() {
    ...
    $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
            console.log(data.smcp.length === 0 && data.Transmission_Implementation.length === 0 && data.accn.length === 0);
...
//            $('#tenaccn').hide();
            ...
            if ((data.smcp.length === 0 && data.Transmission_Implementation.length === 0 && data.accn.length === 0) !== true) {
                ...
                if (data.smcp.length !== 0) {
                    ...
                    if (data.smcp.length >= 6) {
                        $('#sixsmcp').show();
                        $('#sixsmcp').html("<a href='javascript:void(0);' style='font-size:12px;color:black;width:90%' onclick='loadrightchartdata(" + JSON.stringify(data.smcp[5].createdprojectName) + ");'><ji><span><i class='glyphicon glyphicon glyphicon-ok-circle' > </i> " + data.smcp[5].createdprojectName + "<spann>Project Name</spann></ji><ji>&nbsp; | " + data.smcp[5].createdprojectTotalscope + "<spann>Scope</spann></ji><ji>&nbsp; | " + data.smcp[5].createdprojectStartDate + "<spann>Start date</spann></ji><ji>&nbsp; | " + data.smcp[5].createdprojectEndDate + "<spann>End date</spann></ji>&nbsp; | </a>");
                    } else {
                        $('#sixsmcp').remove();
                    }
                    if (data.smcp.length >= 7) {
                        $('#sevensmcp').show();
                        $('#sevensmcp').html("<a href='javascript:void(0);' style='font-size:12px;color:black;width:90%' onclick='loadrightchartdata(" + JSON.stringify(data.smcp[6].createdprojectName) + ");'><ji><span><i class='glyphicon glyphicon glyphicon-ok-circle' > </i> " + data.smcp[6].createdprojectName + "<spann>Project Name</spann></ji><ji>&nbsp; | " + data.smcp[6].createdprojectTotalscope + "<spann>Scope</spann></ji><ji>&nbsp; | " + data.smcp[6].createdprojectStartDate + "<spann>Start date</spann></ji><ji>&nbsp; | " + data.smcp[6].createdprojectEndDate + "<spann>End date</spann></ji>&nbsp; | </a>");
                    } else {
                        $('#sevensmcp').remove();
                    }
                    if (data.smcp.length >= 8) {
                        $('#eightsmcp').show();
                        $('#eightsmcp').html("<a href='javascript:void(0);' style='font-size:12px;color:black;width:90%' onclick='loadrightchartdata(" + JSON.stringify(data.smcp[7].createdprojectName) + ");'><ji><span><i class='glyphicon glyphicon glyphicon-ok-circle' > </i> " + data.smcp[7].createdprojectName + "<spann>Project Name</spann></ji><ji>&nbsp; | " + data.smcp[7].createdprojectTotalscope + "<spann>Scope</spann></ji><ji>&nbsp; | " + data.smcp[7].createdprojectStartDate + "<spann>Start date</spann></ji><ji>&nbsp; | " + data.smcp[7].createdprojectEndDate + "<spann>End date</spann></ji>&nbsp; | </a>");
                    } else {
                        $('#eightsmcp').remove();
                    }
                    if (data.smcp.length >= 9) {
                        $('#niensmcp').show();
                        $('#niensmcp').html("<a href='javascript:void(0);' style='font-size:12px;color:black;width:90%' onclick='loadrightchartdata(" + JSON.stringify(data.smcp[8].createdprojectName) + ");'><ji><span><i class='glyphicon glyphicon glyphicon-ok-circle' > </i> " + data.smcp[8].createdprojectName + "<spann>Project Name</spann></ji><ji>&nbsp; | " + data.smcp[8].createdprojectTotalscope + "<spann>Scope</spann></ji><ji>&nbsp; | " + data.smcp[8].createdprojectStartDate + "<spann>Start date</spann></ji><ji>&nbsp; | " + data.smcp[8].createdprojectEndDate + "<spann>End date</spann></ji>&nbsp; | </a>");
                    } else {
                        $('#niensmcp').remove();
                    }
                    if (data.smcp.length >= 10) {
                        $('#tensmcp').show();
                        $('#tensmcp').html("<a href='javascript:void(0);' style='font-size:12px;color:black;width:90%' onclick='loadrightchartdata(" + JSON.stringify(data.smcp[9].createdprojectName) + ");'><ji><span><i class='glyphicon glyphicon glyphicon-ok-circle' > </i> " + data.smcp[9].createdprojectName + "<spann>Project Name</spann></ji><ji>&nbsp; | " + data.smcp[9].createdprojectTotalscope + "<spann>Scope</spann></ji><ji>&nbsp; | " + data.smcp[9].createdprojectStartDate + "<spann>Start date</spann></ji><ji>&nbsp; | " + data.smcp[9].createdprojectEndDate + "<spann>End date</spann></ji>&nbsp; | </a>");
                    } else {
                        $('#tensmcp').remove();
                    }
...
//                $('#firstWiFi').remove();
                ...
                if (data.Transmission_Implementation.length !== 0) {
                    ...
                    if (data.Transmission_Implementation.length >= 4) {
                        $('#fourTrns').show();
                        $('#fourTrns').html("<a href='javascript:void(0);' style='font-size:12px;color:black;width:90%' onclick='loadrightchartdata(" + JSON.stringify(data.Transmission_Implementation[3].createdprojectName) + ");'><ji><span><i class='glyphicon glyphicon glyphicon-ok-circle' > </i> " + data.Transmission_Implementation[3].createdprojectName + "<spann>Project Name</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[3].createdprojectTotalscope + "<spann>Scope</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[3].createdprojectStartDate + "<spann>Start date</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[3].createdprojectEndDate + "<spann>End date</spann></ji>&nbsp; | </a>");
                    } else {
                        $('#fourTrns').remove();
                    }
                    if (data.Transmission_Implementation.length >= 5) {
                        $('#fiveTrns').show();
                        $('#fiveTrns').html("<a href='javascript:void(0);' style='font-size:12px;color:black;width:90%' onclick='loadrightchartdata(" + JSON.stringify(data.Transmission_Implementation[4].createdprojectName) + ");'><ji><span><i class='glyphicon glyphicon glyphicon-ok-circle' > </i> " + data.Transmission_Implementation[4].createdprojectName + "<spann>Project Name</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[4].createdprojectTotalscope + "<spann>Scope</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[4].createdprojectStartDate + "<spann>Start date</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[4].createdprojectEndDate + "<spann>End date</spann></ji>&nbsp; | </a>");
                    } else {
                        $('#fiveTrns').remove();
                    }
                    if (data.Transmission_Implementation.length >= 6) {
                        $('#sixTrns').show();
                        $('#sixTrns').html("<a href='javascript:void(0);' style='font-size:12px;color:black;width:90%' onclick='loadrightchartdata(" + JSON.stringify(data.Transmission_Implementation[5].createdprojectName) + ");'><ji><span><i class='glyphicon glyphicon glyphicon-ok-circle' > </i> " + data.Transmission_Implementation[5].createdprojectName + "<spann>Project Name</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[5].createdprojectTotalscope + "<spann>Scope</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[5].createdprojectStartDate + "<spann>Start date</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[5].createdprojectEndDate + "<spann>End date</spann></ji>&nbsp; | </a>");
                    } else {
                        $('#sixTrns').remove();
                    }
                    if (data.Transmission_Implementation.length >= 7) {
                        $('#sevenTrns').show();
                        $('#sevenTrns').html("<a href='javascript:void(0);' style='font-size:12px;color:black;width:90%' onclick='loadrightchartdata(" + JSON.stringify(data.Transmission_Implementation[6].createdprojectName) + ");'><ji><span><i class='glyphicon glyphicon glyphicon-ok-circle' > </i> " + data.Transmission_Implementation[6].createdprojectName + "<spann>Project Name</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[6].createdprojectTotalscope + "<spann>Scope</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[6].createdprojectStartDate + "<spann>Start date</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[6].createdprojectEndDate + "<spann>End date</spann></ji>&nbsp; | </a>");
                    } else {
                        $('#sevenTrns').remove();
                    }
                    if (data.Transmission_Implementation.length >= 8) {
                        $('#eightTrns').show();
                        $('#eightTrns').html("<a href='javascript:void(0);' style='font-size:12px;color:black;width:90%' onclick='loadrightchartdata(" + JSON.stringify(data.Transmission_Implementation[7].createdprojectName) + ");'><ji><span><i class='glyphicon glyphicon glyphicon-ok-circle' > </i> " + data.Transmission_Implementation[7].createdprojectName + "<spann>Project Name</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[7].createdprojectTotalscope + "<spann>Scope</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[7].createdprojectStartDate + "<spann>Start date</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[7].createdprojectEndDate + "<spann>End date</spann></ji>&nbsp; | </a>");
                    } else {
                        $('#eightTrns').remove();
                    }
                    if (data.Transmission_Implementation.length >= 9) {
                        $('#nienTrns').show();
                        $('#nienTrns').html("<a href='javascript:void(0);' style='font-size:12px;color:black;width:90%' onclick='loadrightchartdata(" + JSON.stringify(data.Transmission_Implementation[8].createdprojectName) + ");'><ji><span><i class='glyphicon glyphicon glyphicon-ok-circle' > </i> " + data.Transmission_Implementation[8].createdprojectName + "<spann>Project Name</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[8].createdprojectTotalscope + "<spann>Scope</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[8].createdprojectStartDate + "<spann>Start date</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[8].createdprojectEndDate + "<spann>End date</spann></ji>&nbsp; | </a>");
                    } else {
                        $('#nienTrns').remove();
                    }
                    if (data.Transmission_Implementation.length >= 10) {
                        $('#tenTrns').show();
                        $('#tenTrns').html("<a href='javascript:void(0);' style='font-size:12px;color:black;width:90%' onclick='loadrightchartdata(" + JSON.stringify(data.Transmission_Implementation[9].createdprojectName) + ");'><ji><span><i class='glyphicon glyphicon glyphicon-ok-circle' > </i> " + data.Transmission_Implementation[9].createdprojectName + "<spann>Project Name</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[9].createdprojectTotalscope + "<spann>Scope</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[9].createdprojectStartDate + "<spann>Start date</spann></ji><ji>&nbsp; | " + data.Transmission_Implementation[9].createdprojectEndDate + "<spann>End date</spann></ji>&nbsp; | </a>");
                    } else {
                        $('#tenTrns').remove();
                    }
