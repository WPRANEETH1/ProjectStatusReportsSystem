<div id="mainpaneldiv" class="panel panel-default" style="width: 100%;height: auto;background-color: white;padding: 1%;">
    <div class="panel-body" style="padding-top: 0px;">
        <div class="col-sm-12" align="center" style="padding-bottom: 0%;"><h1 style="color: blue;background-color: #d1e0e0"><b>Network Project Implementations</b></h1></div>
        <div class="col-sm-5">

            <div class="col-sm-12" style="background-color: aliceblue;margin: 0px">
                <div class="panel" style="background-color: #d1e0e0;margin: 0px" align="center"><h2 style="color: black"><b>Project Details</b></h2></div>                  
                <div class="col-md-12" style="padding-bottom: 10px;padding-top: 0px">                                        
                    <div class="tree">
                        <ul>
                            <li><a href="#" style="background-color: white;color: black;font-size: 15px;width:55%"><span><i class="glyphicon glyphicon-folder-open" ></i> Small Cell Implementation</span></a>
                                <ul>
                                    <li id="firstIBS"> </li> 
                                    <li id="firstWiFi"> </li>
                                    <li><a href="#" style="background-color: white;color: red;"><span><i class="glyphicon glyphicon glyphicon-open" ></i> See more</span></a>
                        ...
                        <ul>
                            <li><a href="#" style="background-color: white;color: black;font-size: 15px;width:55%"><span><i class="glyphicon glyphicon-folder-open" ></i> Transmission Implementation</span></a>
                                <ul>                                    
                                    <li id="firstTrns"> </li> 
                                    <li><a href="#" style="background-color: white;color: red;"><span><i class="glyphicon glyphicon glyphicon-open" ></i> See more</span></a>
                        ...
                        <ul>
                            <li><a href="#" style="background-color: white;color: black;font-size: 15px;width:55%"><span><i class="glyphicon glyphicon-folder-open" ></i> Access Network</span></a>
                                <ul>
                                    <li id="firstaccn"> </li>
                                    <li id="secondaccn"> </li>
                                    <li id="theardaccn"> </li>
        ...
        <div class="col-sm-7">
            <div class="col-sm-12" style="background-color: #d1e0e0;padding-bottom: 5px">              
                ...
                <div class="col-sm-5" id="datepickerbutton">
